...
![KaseiCoin Contract Compilation](./Images/KaseiCoin_Contract_Compilation.png)

![Crowdsale Contract Compilation](./Images/Crowdsale_Contract_Compilation.png)

![Deployer Contract Compilation](./Images/Deployer_Contract_Compilation.png)

#### Deploying the Contracts:

![Deploying KaseiCoin Contract](./Images/Deploying_KaseiCoin_Contract.png)

![KaseiCoin Contract Deployed](./Images/KaseiCoin_Contract_Deployed.png)

![Crowdsale Contract Deployed](./Images/Deploy_KaseiCoin_Crowdsale.png)

#### Crowdsale Deployer Contract Deployed and Buying Tokens:

![Crowdsale Deployer Contract and Buying Tokens](./Images/Buy_Tokens.png)
